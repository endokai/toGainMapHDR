...
// FIXED: Removed base_image_bool from export format exclusion check
// -b is a parameter modifier, not an export format
...
// FIXED: Now supports -b parameter for custom base image
if apple_gain_map {
